...
export const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    status: 'ai',
    description: '分类意图',
    nodeData: { intents: [], question: '{{input}}' },
    config: outputConfig([
      outputField('intent', '意图'),
      outputField('confidence', '置信度', 'number'),
    ]),
    stub: true,
  },
  {
  ...
  },
  {
    ...
    description: '多模态占位',
    nodeData: { audio: '' },
    config: outputConfig([outputField('text', '文本')]),
    stub: true,
  },
  {
    ...
    description: '多模态占位',
    nodeData: { text: '{{input}}' },
    config: outputConfig([outputField('audio', '音频')]),
    stub: true,
  },
  {
  ...
  },
  {
    ...
    description: '视频生成占位',
    nodeData: { prompt: '{{input}}', modelId: '' },
    config: outputConfig([outputField('video', '视频')]),
    stub: true,
    providerRequired: true,
  },
  {
  ...
  },
  {
    ...
    status: 'ai',
    description: '视频理解占位',
    nodeData: { video: '', prompt: '' },
    config: outputConfig([outputField('text', '理解结果')]),
    stub: true,
    providerRequired: true,
  },
  {
  ...
  },
  {
    ...
    status: 'data',
    description: '聚合字段',
    nodeData: { template: '{{input}}', variables: [] },
    stub: true,
  },
  {
  ...
  },
  {
    ...
    status: 'tool',
    description: '工具库调用模板',
    nodeData: { input: '{{input}}', toolId: '', toolLibId: '' },
  ...
  },
  {
    ...
    nodeData: { input: '{{input}}', workflowId: '', toolId: '' },
  ...
  },
  {
    ...
    category: '工具/其他',
    status: 'input',
    description: '工具工作流入口模板',
    nodeData: { inputFields: [] },
    config: outputConfig([outputField('input', '工具输入')]),
    stub: true,
  },
  {
    type: 'tool-base-node',
    ...
    category: '工具/其他',
    status: 'tool',
    description: '工具工作流基础模板',
    nodeData: { inputFields: [], outputFields: [] },
    config: outputConfig([outputField('output', '工具输出')]),
    stub: true,
  },
  {
    type: 'function-node',
...
export function nodeSummary(type: string, properties?: Record<string, any>) {
  ...
  const summaries: Record<string, string[]> = {
    ...
    'intent-classify-node': [
      `意图 ${compact(data.intents)}`,
      `问题 ${compact(data.question)}`,
    ],
    ...
    'tool-base-node': [
      `输入 ${compact(data.inputFields)}`,
      `输出 ${compact(data.outputFields)}`,
    ],
    'tool-lib-node': [
    ...
    'tool-start-node': [`输入 ${compact(data.inputFields)}`],
    'tool-workflow-lib-node': [
